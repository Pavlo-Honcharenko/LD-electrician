(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".about-photos__slider")) new Swiper(".about-photos__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1.75,
        ...
        if (window.innerWidth < 992) if (document.querySelector(".testimonials__slider")) new Swiper(".testimonials__slider", {
        ...
        if (document.querySelector(".years__slider")) new Swiper(".years__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
